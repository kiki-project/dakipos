        ...
        $.ajax({
            ...
            success: function (response) {            
                ...
                $.each(result, function (i, row) {
                    ...
                    data += '<td style="text-align:right;"><input type="text" class="form-price" value="'+currency(row["poin"]).format().replace("$", "")+'" id="'+3002+row["id"]+'" oninput="currency_price_level('+row['id']+','+3002+', this.value)" style="text-align:right;"></td>';
                    data += '<td style="text-align:right;"><input type="text" class="form-price" value="'+currency(row["komisi"]).format().replace("$", "")+'" id="'+3003+row["id"]+'" oninput="currency_price_level('+row['id']+','+3003+', this.value)" style="text-align:right;"></td>';
                    data += '<td style="text-align:right;"><input type="text" class="form-price" value="'+currency(row["harga_pokok"]).format().replace("$", "")+'" id="'+3004+row["id"]+'" oninput="hitung_currency_price_level('+row['id']+','+3004+', this.value)" style="text-align:right;"></td>';
                    data += '<td style="text-align:right;"><input type="text" class="form-price" value="'+currency(row["jumlah"]).format().replace("$", "")+'" id="'+3007+row["id"]+'" oninput="hitung_currency_price_level('+row['id']+','+3007+', this.value)" style="text-align:right;"></td>';
                    data += '<td style="text-align:right;"><input type="text" class="form-price" value="'+currency(row["jumlah2"]).format().replace("$", "")+'" id="'+30072+row["id"]+'" oninput="hitung_currency_price_level('+row['id']+','+30072+', this.value)" style="text-align:right;"></td>';
                    data += '<td style="text-align:right;"><input type="text" class="form-price" value="'+currency(row["jumlah3"]).format().replace("$", "")+'" id="'+30073+row["id"]+'" oninput="hitung_currency_price_level('+row['id']+','+30073+', this.value)" style="text-align:right;"></td>';
                    data += '<td style="text-align:right;"><input type="text" class="form-price" value="'+currency(row["proc"]).format().replace("$", "")+'" id="'+3005+row["id"]+'" oninput="hitung_currency_price_level('+row['id']+','+3005+', this.value)" style="text-align:right;"></td>';
                    data += '<td style="text-align:right;"><input type="text" class="form-price" value="'+currency(row["proc2"]).format().replace("$", "")+'" id="'+30052+row["id"]+'" oninput="hitung_currency_price_level('+row['id']+','+30052+', this.value)" style="text-align:right;"></td>';
                    data += '<td style="text-align:right;"><input type="text" class="form-price" value="'+currency(row["proc3"]).format().replace("$", "")+'" id="'+30053+row["id"]+'" oninput="hitung_currency_price_level('+row['id']+','+30053+', this.value)" style="text-align:right;"></td>';
