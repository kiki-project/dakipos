        ...
        <div class="card">
          ...
          <div class="card-header d-flex p-0">
            <h3 class="card-title p-3">
            	   <a href="<?php echo base_url(); ?>edit-suppliers/new" class="btn btn-sm bg-color1" style="color: #fff;"><i class="fa fa-plus"></i> Tambah Data</a>
            </h3>
          </div>
                  <?php
                }
                  ...
                  <tr>
                    ...
                    <td>
                      <?php 
                        if ($rm['edit'] != 'None') {
                          ?>
                          <a href="<?php echo base_url(); ?>edit-suppliers/<?php echo $key->kode; ?>" class="btn btn-sm btn-primary"><i class="fa fa-edit" title="Edit"></i></a>
                          <?php
                        }
                        if ($rm['delete'] != 'None') {
                             
                            ?>
                            <a href="<?php echo base_url(); ?>delete-suppliers/<?php echo $key->id; ?>" class="btn btn-sm btn-danger" title="hapus data" onclick="return confirm('hapus data?')"><i class="fa fa-trash"></i></a>
                            <?php
