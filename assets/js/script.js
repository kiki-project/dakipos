...
function frm_jenis_item(){
        ...
        success: function (response) { 
            ...
            $.each(result, function(i, row) {
                data += '<tr>'
                data += '<td><input type="checkbox" id="cb_item_types" name="cb_item_types[]" value="'+row['id']+'"></td>'
                data += '<td>'+row['kode']+'</td>'
...
function frm_brands_item(){
        ...
        success: function (response) { 
            ...
            $.each(result, function(i, row) {
                data += '<tr>'
                data += '<td><input type="checkbox" id="cb_item_brands" name="cb_item_brands[]" value="'+row['id']+'"></td>'
                data += '<td>'+row['kode']+'</td>'
                data += '<td>'+row['description']+'</td>'
                data += '</tr>'
            });
...
function set_currency_value(id,num){
    var num = num.replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(".00", "");
    var num = currency(num).format().replace("$", "").replace(",", "").replace(",", "").replace(",", "");
...
function input_clear_currency(id){
    if (id == 'item-persentase') {
    var hrg_pok = $('#item-harga-pokok').val().replace(".00", "").replace(",", "")
...
function get_item_list_radio(a,b){
        ...
        success: function (response) {
            ...
            $.each(result, function(i, row) {
                data += '<tr>'
                data += '<td><input type="radio" id="rd_kode" name="kode" value="'+row['kode']+'"></td>'
                data += '<td>'+row['kode']+'</td>'
                data += '<td>'+row['name']+'</td>'
...
function hitung_orders(id){
    var hrg = $('#harga').val().replace(".00", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "")
    var qty = $('#sub_total_item').val().replace(".00", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "")
    var pot = $('#potongan').val().replace(".00", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "")
    var pot_n = (pot * (hrg * qty)  / 100)
    var ipot_nota_p = $('#pot_nota_percent').val().replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "")
    var ipot_nota_n = $('#pot_nota_nilai').val().replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "")
    var ipajak_p = $('#pajak_percent').val().replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "")
    var ipajak_n = $('#pajak_nilai').val().replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "")
    var dp = $('#dp').val().replace(".00", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "")
    ...
    $('#total_akhir_harga').val(currency(val_hrg_akhir).format().replace("$", ""))
...
function hitung_purchases(id){
    ...
    var ipajak_n = $('#pajak_nilai').val().replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "")
    var dp = $('#dp').val().replace(".00", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "")
    var biaya_lain = $('#biaya_lain').val().replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "").replace(",", "")
